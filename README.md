# PhaseForge Concept Map: Background, Learning, and Research Interests
...
```text
Fundamental Investigation of the Tensile Behavior
and Lattice Thermal Conductivity of AlxCoCrFeNi
(0.1 <= x <= 0.7) High-Entropy Alloys:
An Atomistic Study
```

Using LAMMPS, I developed input scripts and carried out:

- uniaxial tensile simulation;
- generalized stacking-fault energy analysis;
- lattice thermal conductivity simulation;
...
My undergraduate research mainly follows:
...
Molecular dynamics
      |
      v
Mechanical / thermal / defect properties
```

The direction I now want to explore is:

```text
Atomistic energetics
      |
      v
...
Phase equilibrium
      |
      v
Eventually to Physical Metallurgy: microstructure and properties
```

This transition is the main reason the PhaseForge opportunity interests me.

## Current Experience, Recent Exploration, and Future Interests

| Area | My current position |
|---|---|
| LAMMPS molecular dynamics | Direct undergraduate research experience |
| Tensile simulation | Direct undergraduate research experience |
| GSFE | Direct undergraduate research experience |
| Lattice thermal conductivity | Direct undergraduate research experience |
| PDOS and MSD | Direct undergraduate research experience |
| Atomsk polycrystal generation | Recent hands-on exploration |
| Python | Used for coursework and recent projects |
| Machine learning | Coursework foundation and small regression project |
| pycalphad | Recent introductory hands-on exploration |
| CHGNet | Recent introductory hands-on exploration using a pretrained model |
| Formation-energy analysis | Recent introductory hands-on exploration |
| CALPHAD model development | Future PhD learning interest |
| MLIP training and validation | Future PhD learning interest |
| SQS and systematic structure sampling | Future PhD learning interest |
| Bayesian inference and uncertainty quantification | Future PhD learning interest |
| Active learning | Future PhD learning interest |
| Phase-field modeling | Longer-term research interest |
...
```text
PhaseForge_Concept_Map/
│
├── README.md
├── 01_Thermodynamics_and_CALPHAD.md
├── 02_Atomistic_Modeling_and_MLIPs.md
├── 03_Phase_Stability_and_Structure_Sampling.md
├── 04_Bayesian_UQ_and_Active_Learning.md
├── 05_Microstructure_and_Phase_Field.md
...
- how CALPHAD models are constructed and calibrated;
- how atomistic calculations can provide useful thermodynamic data;
- how ML interatomic potentials are trained, validated, and used responsibly;
- how disordered alloy structures are represented more systematically than simple random configurations;
